...
Source: https://github.com/bokeh/bokeh/blob/branch-3.3/examples/server/app/server_auth/auth.py
...
class LoginHandler(RequestHandler):
    def get(self):
        try:
            ...
            errormessage = ""
        self.render("templates/admin_login.html.jinja2", errormessage=errormessage)
